...
(function(){
  ...
  @media(max-width:767px){.ng-live-feedbacks{width:100%;margin:14px auto 22px}.ng-live-feedbacks__track{gap:13px;animation-duration:29s}.ng-live-feedbacks__card{width:78vw}}
  @media(prefers-reduced-motion:reduce){.ng-live-feedbacks__track{animation:none}.ng-live-reveal{opacity:1!important;transform:none!important;transition:none!important}}
  ...
  function init(){plus20();feedbacks();reveal()}
